package cn.qinguide.f5web.xposed.share;
/**
...
import cn.qinguide.f5web.xposed.share.cache.DiskCache;
import cn.qinguide.f5web.xposed.share.cache.MemoryCache;
...
public final class Share {
    ...
    public static int getInt(String key, int defalut) {
        if (memoryCache == null || diskCache == null) return -1; //未初始化
    ...
    public static String getString(String key) {
        if (memoryCache == null || diskCache == null) return null;
